...
def transform_cat_columns(dataset_splits, scat_trans_name, num_param, cols):
    ...
    return X_scat_train_trans, X_scat_test_trans, cat_columns
...
def transform_datasets(dataset_configs: dict):
    ...
    for marca, dataset_config in tqdm(dataset_configs.items()):
        ...
        X_scat_train_trans, X_scat_test_trans, scat_columns = transform_cat_columns(
            dataset_config,
            scat_trans_name,
            num_param,
            SMALL_CATEGORICAL_COLUMNS
        ...
        X_lcat_train_trans, X_lcat_test_trans, lcat_columns = transform_cat_columns(
            dataset_config,
            lcat_trans_name,
            num_param,
            LARGE_CATEGORICAL_COLUMNS
